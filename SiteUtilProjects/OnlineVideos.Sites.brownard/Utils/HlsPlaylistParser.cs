...
namespace OnlineVideos.Sites.Utils
{
    ...
    public class HlsPlaylistParser
    {
        ...
        public HlsPlaylistParser(string playlist, string originalUrl)
        {
            PopulateStreamInfo(playlist, originalUrl);
        }

        public List<HlsStreamInfo> StreamInfos
        {
        ...
        protected void PopulateStreamInfo(string playlist, string originalUrl)
        {
            ...
            while ((line = reader.ReadLine()) != null)
            {
                ...
                else if (line != string.Empty && !line.StartsWith("#"))
                {
                    ...
                    streamInfos.Add(new HlsStreamInfo(bandwidth, width, height, streamUrl.ToString()));
                    bandwidth = 0;
                    width = 0;
                    height = 0;
                }
