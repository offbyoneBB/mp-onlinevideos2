...
namespace OnlineVideos.Sites.doskabouter.Vimeo
{

    public class AuthBase
    {
        public const string ConsumerKey = "1ed5bbef8472dbeb76f66fbe963642d7";
        public static string ConsumerSecret = "your consumer secret";

        public static string BuildOAuthApiRequestUrl(string url)
        {
            var oAuth = new AuthBase();
            ...
            out string normalizedRequestParameters)
        {
            ...
            UInt64 c2 = BitConverter.ToUInt64(Encoding.ASCII.GetBytes(consumerSecret), 0) ^ 0xd647b7df8f679fa6;
