...
namespace OnlineVideos.Hoster
{
    public class Vimeo : HosterBase
    {
        ...
        public override string getVideoUrls(string url)
        {
            ...
            {
                Match n = Regex.Match(page, @"{""cached_timestamp"":[^,]*,""source"":""cache"",""signature"":""(?<signature>[^""]*)"",""timestamp"":(?<timestamp>[^,]*),""referrer"":.+?,""vimeo_url"":""vimeo\.com"",""player_url"":""player\.vimeo\.com"",""cdn_url"":""a\.vimeocdn\.com"",""cookie_domain"":""\.vimeo\.com""},""video"":{""id"":(?<id>[^,]*),""title");
                if (n.Success)
                {
