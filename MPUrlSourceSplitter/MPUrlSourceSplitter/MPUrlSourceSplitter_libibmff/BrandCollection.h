...
#ifndef __BRAND_COLLECTION_DEFINED
#define __BRAND_COLLECTION_DEFINED

#include "Collection.h"
#include "Brand.h"

class CBrandCollection : public CCollection<CBrand, const wchar_t *>
{
public:
...
protected:
  ...
  const wchar_t *GetKey(CBrand *item);

  // clones specified item
  // @param item : the item to clone
  // @return : deep clone of item or NULL if not implemented
  CBrand *Clone(CBrand *item);
