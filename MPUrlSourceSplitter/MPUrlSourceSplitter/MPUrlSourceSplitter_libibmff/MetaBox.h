...
#ifndef __META_BOX_DEFINED
#define __META_BOX_DEFINED
...
public:
  ...
  // gets handler box
  // @return : handler box or NULL if error
  virtual CHandlerBox *GetHandlerBox(void);
...
protected:
  ...
  // handler box which must be part of meta box
  CHandlerBox *handlerBox;
