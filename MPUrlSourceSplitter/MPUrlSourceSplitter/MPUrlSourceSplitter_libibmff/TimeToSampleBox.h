...
#ifndef __TIME_TO_SAMPLE_BOX_DEFINED
#define __TIME_TO_SAMPLE_BOX_DEFINED
...
public:
  ...
  // gets chunk offsets
  // @return : chunk offset
  virtual CTimeToSampleCollection *GetTimesToSamples(void);
...
protected:
  ...
  CTimeToSampleCollection *timesToSamples;
