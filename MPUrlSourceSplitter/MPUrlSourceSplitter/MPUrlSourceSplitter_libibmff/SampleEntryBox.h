...
public:
  ...
  // sets the index of the data reference to use to retrieve data associated with samples
  // @param dataReferenceIndex : the index of the data reference to use to retrieve data associated with samples
  virtual void SetDataReferenceIndex(uint16_t dataReferenceIndex);
