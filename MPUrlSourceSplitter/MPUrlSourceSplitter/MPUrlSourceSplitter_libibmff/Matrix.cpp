...
int CMatrix::CompareItemKeys(const wchar_t *firstKey, const wchar_t *secondKey, void *context)
{
...
const wchar_t *CMatrix::GetKey(CFixedPointNumber *item)
{
  return L"";
}
...
bool CMatrix::Append(CCollection<CFixedPointNumber, const wchar_t *> *collection)
{
  return false;
}
