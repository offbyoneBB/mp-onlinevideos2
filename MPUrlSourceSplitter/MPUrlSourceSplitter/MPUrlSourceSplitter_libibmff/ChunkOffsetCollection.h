...
#ifndef __CHUNK_OFFSET_COLLECTION_DEFINED
#define __CHUNK_OFFSET_COLLECTION_DEFINED

#include "Collection.h"
#include "ChunkOffset.h"

class CChunkOffsetCollection : public CCollection<CChunkOffset, const wchar_t *>
{
public:
...
protected:
  ...
  const wchar_t *GetKey(CChunkOffset *item);

  // clones specified item
  // @param item : the item to clone
  // @return : deep clone of item or NULL if not implemented
  CChunkOffset *Clone(CChunkOffset *item);
