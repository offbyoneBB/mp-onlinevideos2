...
#ifndef __SIMPLEPROTOCOLINTERFACE_DEFINED
#define __SIMPLEPROTOCOLINTERFACE_DEFINED
...
public:
  ...
  virtual HRESULT StartReceivingData(const CParameterCollection *parameters) = 0;
