...
#ifndef __AKAMAI_FLV_PACKET_COLLECTION_DEFINED
#define __AKAMAI_FLV_PACKET_COLLECTION_DEFINED

#include "Collection.h"
#include "AkamaiFlvPacket.h"

class CAkamaiFlvPacketCollection : public CCollection<CAkamaiFlvPacket, const wchar_t *>
{
public:
  CAkamaiFlvPacketCollection(void);
  ~CAkamaiFlvPacketCollection(void);
...
protected:
  ...
  const wchar_t *GetKey(CAkamaiFlvPacket *item);

  // clones specified item
  // @param item : the item to clone
  // @return : deep clone of item or NULL if not implemented
  CAkamaiFlvPacket *Clone(CAkamaiFlvPacket *item);
