...
int CRtmpStreamFragmentCollection::CompareItemKeys(const wchar_t *firstKey, const wchar_t *secondKey, void *context)
{
...
const wchar_t *CRtmpStreamFragmentCollection::GetKey(CRtmpStreamFragment *item)
{
  return L"";
}
