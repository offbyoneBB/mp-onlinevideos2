...
MPURLSOURCESPLITTER_API wchar_t *GetTvServerFolder(void);
...
MPURLSOURCESPLITTER_API wchar_t *GetMediaPortalFolder(void);
...
MPURLSOURCESPLITTER_API wchar_t *GetTvServerFilePath(const TCHAR *filePath);
...
// @return : reference to null terminated string with path of file or NULL if error occured
MPURLSOURCESPLITTER_API wchar_t *GetMediaPortalFilePath(const TCHAR *filePath);

// clear url components
// @param url : url components to clear
MPURLSOURCESPLITTER_API void ZeroURL(URL_COMPONENTS *url);
