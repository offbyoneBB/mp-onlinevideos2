...
#ifndef __FRAGMENTED_INDEX_COLLECTION_DEFINED
#define __FRAGMENTED_INDEX_COLLECTION_DEFINED

#include "Collection.h"
#include "FragmentedIndex.h"

class CFragmentedIndexCollection : public CCollection<CFragmentedIndex, const wchar_t *>
{
public:
...
protected:
  ...
  const wchar_t *GetKey(CFragmentedIndex *item);

  // clones specified item
  // @param item : the item to clone
  // @return : deep clone of item or NULL if not implemented
  CFragmentedIndex *Clone(CFragmentedIndex *item);
