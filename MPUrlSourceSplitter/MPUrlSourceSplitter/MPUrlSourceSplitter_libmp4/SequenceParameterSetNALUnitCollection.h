...
class CSequenceParameterSetNALUnitCollection : public CCollection<CSequenceParameterSetNALUnit, const wchar_t *>
{
public:
...
protected:
  ...
  const wchar_t *GetKey(CSequenceParameterSetNALUnit *item);
