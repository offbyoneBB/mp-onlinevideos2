...
"%progpath%\Microsoft Visual Studio\2019\Community\MSBuild\Current\Bin\MSBUILD.exe" /target:Rebuild /property:Configuration=%BUILD_TYPE% "..\OnlineVideos.MediaPortal1.sln" >> %LOG%
