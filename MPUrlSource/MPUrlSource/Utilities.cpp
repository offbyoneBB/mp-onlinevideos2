...
//unsigned int FillBufferStandard(CLogger *logger, const TCHAR *protocolName, const TCHAR *functionName, HANDLE lockMutex, LinearBuffer *buffer, IMediaSample *pSamp, char *pData, long cbData)
//{
