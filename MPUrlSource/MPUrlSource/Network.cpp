...
int GetIpAddress(const TCHAR *serverName, WORD port, ADDRINFOT **address, const ADDRINFOT *pHints)
{
  ADDRINFOT hints;
...
bool SockAddrIsMulticast(const ADDRINFOT *addr)
{
...
TCHAR *GetInterfaceAddress(CLogger *logger, const TCHAR *protocolName, const TCHAR *interfaceName, int family)
{
...
ULONG GetInterfaceId(CLogger *logger, const TCHAR *protocolName, const TCHAR *interfaceName, int family)
{
...
int JoinMulticastGroupIPv4(CLogger *logger, const TCHAR *protocolName, SOCKET m_socket, const struct sockaddr_in *source, const struct sockaddr_in *local, CParameterCollection *parameters)
{
  int result = 0;
...
int JoinMulticastGroupIPv6(CLogger *logger, const TCHAR *protocolName, SOCKET m_socket, const struct sockaddr_in6 *local, CParameterCollection *parameters)
{
  int result = 0;
...
int SubscribeToMulticastGroup(CLogger *logger, const TCHAR *protocolName, SOCKET m_socket, const struct sockaddr *source, socklen_t sourceLen, const struct sockaddr *local, socklen_t localLen, CParameterCollection *parameters)
{
  int result = 0;
  int level;
  ULONG iid = 0;
...
int LeaveMulticastGroupIPv4(CLogger *logger, const TCHAR *protocolName, SOCKET m_socket, const struct sockaddr_in *source, const struct sockaddr_in *local, CParameterCollection *parameters)
{
  ADDRINFOT *networkInterface = NULL;
  ADDRINFOT hints;
  hints.ai_family = local->sin_family;
...
int LeaveMulticastGroupIPv6(CLogger *logger, const TCHAR *protocolName, SOCKET m_socket, const struct sockaddr_in6 *local, CParameterCollection *parameters)
{
  int result = 0;
  struct ipv6_mreq gr6;
  memset(&gr6, 0, sizeof(gr6));
...
int UnsubscribeFromMulticastGroup(CLogger *logger, const TCHAR *protocolName, SOCKET m_socket, const struct sockaddr *source, socklen_t sourceLen, const struct sockaddr *local, socklen_t localLen, CParameterCollection *parameters)
{
  int result = 0;
  int level;
  ULONG iid = 0;
...
SOCKET CreateSocket(CLogger *logger, const TCHAR *protocolName, const TCHAR *functionName, int family, int type, int protocol)
{
...
int SetSocketOption(CLogger *logger, const TCHAR *protocolName, const TCHAR *functionName, const TCHAR *optionName, SOCKET s, int level, int optname, const char *optval, int optlen)
{
  int result = 0;
...
int GetSocketOption(CLogger *logger, const TCHAR *protocolName, const TCHAR *functionName, const TCHAR *optionName, SOCKET s, int level, int optname, char *optval, int *optlen)
{
  int result = 0;
...
int SetAndCheckSocketOption(CLogger *logger, const TCHAR *protocolName, const TCHAR *functionName, const TCHAR *optionName, SOCKET s, int level, int optname, const char *optval, int optlen)
{
...
int SetBlockingMode(CLogger *logger, const TCHAR *protocolName, const TCHAR *functionName, SOCKET s, bool blocking)
{
  int result = 0;
...
int Bind(CLogger *logger, const TCHAR *protocolName, const TCHAR *functionName, SOCKET s, const sockaddr *name, int namelen)
{
  int result = 0;
...
int Connect(CLogger *logger, const TCHAR *protocolName, const TCHAR *functionName, SOCKET s, const sockaddr *name, int namelen, unsigned int timeout, bool read, bool write)
{
  int result = 0;
...
int ProcessError(CLogger *logger, const TCHAR *protocolName, const TCHAR *functionName, const TCHAR *networkFunctionName, SOCKET s, unsigned int timeout, bool read, bool write)
{
  int result = 0;
...
int SendString(CLogger *logger, const TCHAR *protocolName, const TCHAR *functionName, SOCKET s, const TCHAR *buffer, int flags, unsigned int timeout)
{
...
int GetDataFromSocket(CLogger *logger, const TCHAR *protocolName, const TCHAR *functionName, SOCKET s, char *buffer, unsigned int length)
{
