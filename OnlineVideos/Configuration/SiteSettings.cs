...
" + siteXml + @"
        ...
        private static void CallOnDeserializedRecursive(IList<Category> cats, StreamingContext ctx)
        {
            if (cats != null)
            {
        ...
        private static void CallOnSerializingRecursive(IList<Category> cats, StreamingContext ctx)
        {
            if (cats != null)
            {
                foreach (var cat in cats)
    ...
    public class SiteSettings : MarshalByRefObject
    {
        ...
        protected DateTime _dynamicCategoriesDiscoveryTime = DateTime.MinValue;
        protected bool _dynamicCategoriesDiscovered;
        ...
        public bool DynamicCategoriesDiscovered
        {
            get
            {
                if (_dynamicCategoriesDiscovered && Categories != null && Categories.Count > 0 && (DateTime.Now - _dynamicCategoriesDiscoveryTime).TotalMinutes > OnlineVideoSettings.Instance.DynamicCategoryTimeout)
                {
                    _dynamicCategoriesDiscovered = false;
                    int i = 0;
                ...
                return _dynamicCategoriesDiscovered;
            }
            set { _dynamicCategoriesDiscovered = value; if (value) _dynamicCategoriesDiscoveryTime = DateTime.Now; }
        }
    ...
    public class Category : SearchResultItem, IComparable<Category>
    {
        ...
        protected DateTime _subCategoriesDiscoveryTime = DateTime.MinValue;
        protected bool _subCategoriesDiscovered;
        ...
        public bool SubCategoriesDiscovered
        {
            get
            {
                if (_subCategoriesDiscovered && SubCategories != null && SubCategories.Count > 0 && (DateTime.Now - _subCategoriesDiscoveryTime).TotalMinutes > OnlineVideoSettings.Instance.DynamicCategoryTimeout)
                {
                    _subCategoriesDiscovered = false;
                    int i = 0;
                ...
                return _subCategoriesDiscovered;
            }
            set { _subCategoriesDiscovered = value; if (value) _subCategoriesDiscoveryTime = DateTime.Now; }
        }
