...
namespace OnlineVideos.MPUrlSourceFilter
{
    ...
    public abstract class SimpleUrl
    {
        ...
        /// </summary>
        internal virtual string ToFilterString()
        {
        ...
        public static SimpleUrl FromString(string data)
        {
            Byte[] rawContent = Convert.FromBase64String(data);
            using (MemoryStream stream = new MemoryStream(rawContent.Length))
            {
                ...
                BinaryFormatter serializer = new BinaryFormatter();
                return serializer.Deserialize(stream) as OnlineVideos.MPUrlSourceFilter.SimpleUrl;
            }
        }
