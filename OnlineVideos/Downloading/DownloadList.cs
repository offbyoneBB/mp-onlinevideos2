...
namespace OnlineVideos.Downloading
{
    public class DownloadList : MarshalByRefObject
    {
        ...
        {
            DownloadList di = (DownloadList)CrossDomain.OnlineVideosAssemblyContext.CreateCrossDomainInstance(typeof(DownloadList), System.Reflection.BindingFlags.CreateInstance | System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic, null, null, null, null);
