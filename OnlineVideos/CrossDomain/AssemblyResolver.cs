...
namespace OnlineVideos.CrossDomain
{
    ...
    public static class AssemblyResolver
    {
        ...
        {
            RedirectAllAssemblies(AppDomain.CurrentDomain);
        }

        public static void RedirectAllAssemblies(AppDomain domain, string applicationRootFolder = null)
        {
            var dir = Path.GetDirectoryName(applicationRootFolder ?? Assembly.GetEntryAssembly()?.Location);
            if (dir == null)
                return;
            ...
            domain.ReflectionOnlyAssemblyResolve += CurrentDomain_ResolveAssembly;
            domain.AssemblyResolve += CurrentDomain_ResolveAssembly;
        }
