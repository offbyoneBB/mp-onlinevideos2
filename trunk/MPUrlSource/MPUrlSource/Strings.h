...
MPURLSOURCE_API char *ConvertGuidToStringA(const GUID guid);

// converts GUID to Unicode string
// @param guid : GUID to convert
// @return : reference to null terminated string or NULL if error occured
MPURLSOURCE_API wchar_t *ConvertGuidToStringW(const GUID guid);
...
// @return : reference to null terminated string or NULL if error occured
MPURLSOURCE_API char *ConvertToMultiByteA(const char *string);

// converts string to mutli byte string
// @param string : string to convert
// @return : reference to null terminated string or NULL if error occured
MPURLSOURCE_API char *ConvertToMultiByteW(const wchar_t *string);

// converts string to Unicode string
// @param string : string to convert
// @return : reference to null terminated string or NULL if error occured
MPURLSOURCE_API wchar_t *ConvertToUnicodeA(const char *string);

// converts string to Unicode string
// @param string : string to convert
// @return : reference to null terminated string or NULL if error occured
MPURLSOURCE_API wchar_t *ConvertToUnicodeW(const wchar_t *string);
...
// @return : reference to null terminated string or NULL if error occured
MPURLSOURCE_API char *DuplicateA(const char *string);

// duplicate Unicode string
// @param string : string to duplicate
// @return : reference to null terminated string or NULL if error occured
MPURLSOURCE_API wchar_t *DuplicateW(const wchar_t *string);
...
MPURLSOURCE_API bool IsNullOrEmptyA(const char *string);

// tests if Unicode string is null or empty
// @param string : string to test
// @return : true if null or empty, otherwise false
MPURLSOURCE_API bool IsNullOrEmptyW(const wchar_t *string);
...
MPURLSOURCE_API char *FormatStringA(const char *format, ...);

// formats string using format string and parameters
// @param format : format string
// @return : result string or NULL if error
MPURLSOURCE_API wchar_t *FormatStringW(const wchar_t *format, ...);
...
MPURLSOURCE_API char *ReplaceStringA(const char *string, const char *searchString, const char *replaceString);

MPURLSOURCE_API wchar_t *ReplaceStringW(const wchar_t *string, const wchar_t *searchString, const wchar_t *replaceString);
