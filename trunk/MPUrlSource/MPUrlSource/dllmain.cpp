...
#define g_wszPullSource                                           L"MediaPortal Url Source Filter"
...
{
  &CLSID_MPUrlSourceFilter,     // Filter CLSID
  g_wszPullSource,              // String name
...
CFactoryTemplate g_Templates[1] = 
{
  { 
    ...
    &CLSID_MPUrlSourceFilter,           // CLSID
    CMPUrlSourceFilter::CreateInstance, // Method to create an instance
