...
MPURLSOURCE_API int GetIpAddress(const TCHAR *serverName, WORD port, ADDRINFOT **address, const ADDRINFOT *pHints);

// test if address is in multicast range
// @param addr : the address to test
// @return : true if address is in multicast range, false otherwise
MPURLSOURCE_API bool SockAddrIsMulticast(const ADDRINFOT *addr);
...
MPURLSOURCE_API TCHAR *GetInterfaceAddress(CLogger *logger, const TCHAR *protocolName, const TCHAR *interfaceName, int family);
...
MPURLSOURCE_API ULONG GetInterfaceId(CLogger *logger, const TCHAR *protocolName, const TCHAR *interfaceName, int family);
...
// @return: 0 if success
MPURLSOURCE_API int JoinMulticastGroupIPv4(CLogger *logger, const TCHAR *protocolName, SOCKET m_socket, const struct sockaddr_in *source, const struct sockaddr_in *local, CParameterCollection *parameters);
...
// @param parameters : various parameters for connection
// @return: 0 if success
MPURLSOURCE_API int JoinMulticastGroupIPv6(CLogger *logger, const TCHAR *protocolName, SOCKET m_socket, const struct sockaddr_in6 *local, CParameterCollection *parameters);
...
// @param parameters : various parameters for connection
// @return: 0 if success
MPURLSOURCE_API int SubscribeToMulticastGroup(CLogger *logger, const TCHAR *protocolName, SOCKET m_socket, const struct sockaddr *source, socklen_t sourceLen, const struct sockaddr *local, socklen_t localLen, CParameterCollection *parameters);
...
// @param parameters : various parameters for connection
// @return: 0 if success
MPURLSOURCE_API int LeaveMulticastGroupIPv4(CLogger *logger, const TCHAR *protocolName, SOCKET m_socket, const struct sockaddr_in *source, const struct sockaddr_in *local, CParameterCollection *parameters);
...
// @param parameters : various parameters for connection
// @return: 0 if success
MPURLSOURCE_API int LeaveMulticastGroupIPv6(CLogger *logger, const TCHAR *protocolName, SOCKET m_socket, const struct sockaddr_in6 *local, CParameterCollection *parameters);
...
// @param parameters : various parameters for connection
// @return: 0 if success
MPURLSOURCE_API int UnsubscribeFromMulticastGroup(CLogger *logger, const TCHAR *protocolName, SOCKET m_socket, const struct sockaddr *source, socklen_t sourceLen, const struct sockaddr *local, socklen_t localLen, CParameterCollection *parameters);

// clear url components
// @param url : url components to clear
MPURLSOURCE_API void ZeroURL(URL_COMPONENTS *url);
...
MPURLSOURCE_API SOCKET CreateSocket(CLogger *logger, const TCHAR *protocolName, const TCHAR *functionName, int family, int type, int protocol);
...
MPURLSOURCE_API int SetSocketOption(CLogger *logger, const TCHAR *protocolName, const TCHAR *functionName, const TCHAR *optionName, SOCKET s, int level, int optname, const char *optval, int optlen);
...
// @return : if no error occurs return zero, otherwise a value of WSAGetLastError()
MPURLSOURCE_API int GetSocketOption(CLogger *logger, const TCHAR *protocolName, const TCHAR *functionName, const TCHAR *optionName, SOCKET s, int level, int optname, char *optval, int *optlen);
...
MPURLSOURCE_API int SetAndCheckSocketOption(CLogger *logger, const TCHAR *protocolName, const TCHAR *functionName, const TCHAR *optionName, SOCKET s, int level, int optname, const char *optval, int optlen);
...
// @return : if no error occurs return zero, otherwise a value of WSAGetLastError()
MPURLSOURCE_API int SetBlockingMode(CLogger *logger, const TCHAR *protocolName, const TCHAR *functionName, SOCKET s, bool blocking);
...
// @return : if no error occurs return zero, otherwise a value of WSAGetLastError()
MPURLSOURCE_API int Bind(CLogger *logger, const TCHAR *protocolName, const TCHAR *functionName, SOCKET s, const sockaddr *name, int namelen);
...
MPURLSOURCE_API int ProcessError(CLogger *logger, const TCHAR *protocolName, const TCHAR *functionName, const TCHAR *networkFunctionName, SOCKET s, unsigned int timeout, bool read, bool write);
...
// @param write : specifies if socket have to be writable 
// @return : if no error occurs return zero, otherwise a value of WSAGetLastError(), -1 when socket is not readable, -2 when socket is not writable, -3 when socket is not readable and writable
MPURLSOURCE_API int Connect(CLogger *logger, const TCHAR *protocolName, const TCHAR *functionName, SOCKET s, const sockaddr *name, int namelen, unsigned int timeout, bool read, bool write);
...
MPURLSOURCE_API int Send(CLogger *logger, const TCHAR *protocolName, const TCHAR *functionName, SOCKET s, const char *buffer, int length, int flags, unsigned int timeout);
...
// @param timeout : the maximum time to wait, NULL if not specified
// @return : if no error occurs return zero, otherwise a value of WSAGetLastError() or E_OUTOFMEMORY if not enough memory
MPURLSOURCE_API int SendString(CLogger *logger, const TCHAR *protocolName, const TCHAR *functionName, SOCKET s, const TCHAR *buffer, int flags, unsigned int timeout);
...
MPURLSOURCE_API int GetDataFromSocket(CLogger *logger, const TCHAR *protocolName, const TCHAR *functionName, SOCKET s, char *buffer, unsigned int length);
