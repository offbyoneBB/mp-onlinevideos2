...
namespace OnlineVideos.MediaPortal1.Player
{
    public class OnlineVideosPlayer : VideoPlayerVMR9, OVSPLayer
    {
        ...
        public static String GetFilterUrl(IBaseFilter sourceFilter, Sites.SiteUtilBase siteUtil, String url)
        {
            ...
            if (filterStateEx != null)
            {
                ...
                if (index != (-1))
                {
                    ...
                    String encodedContent = url.Substring(index + MPUrlSourceSplitter.V2.SimpleUrl.ParameterSeparator.Length);
            ...
            else
            {
                ...
                int index = url.IndexOf(MPUrlSourceSplitter.V1.SimpleUrl.ParameterSeparator);
                if (index != (-1))
                {
                    OnlineVideos.MediaPortal1.MPUrlSourceSplitter.V1.SimpleUrl filterUrl = null;
                    OnlineVideos.MPUrlSourceFilter.SimpleUrl simpleUrl = null;

                    String encodedContent = url.Substring(index + MPUrlSourceSplitter.V1.SimpleUrl.ParameterSeparator.Length);
                    Byte[] rawContent = Convert.FromBase64String(encodedContent);
        ...
        public bool BufferFile(Sites.SiteUtilBase siteUtil)
        {
            ...
            try
            {
                ...
                if (filterStateEx != null)
                {
                    ...
                    String url = OnlineVideosPlayer.GetFilterUrl(sourceFilter, siteUtil, m_strCurrentFile);
