...
namespace OnlineVideos.MediaPortal1
{
	partial class Configuration
	{
        ...
        "isplay.");
            ...
            this.toolTip1.SetToolTip(this.tbxLatestVideosAmount, "Number of latest video items to set data concurrently. Default is 3. Set to 0 to disable this feature.");
