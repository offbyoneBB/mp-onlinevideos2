...
namespace OnlineVideos.Sites
{
    public class Pro7Util : SiteUtilBase
    {
        ...
        string baseUrl = "http://cms002.dc2.qcn3.movenetworks.com/cms/publish/vod2/vodchannelcatalog/pro7/7/catalog.json";
        string vidListBaseUrl = "http://cms002.dc2.qcn3.movenetworks.com/cms/publish/pro7/vodtldatesorted//";

        string rtmp_d_at_ch = "rtmpt://pssimp7lsfs.fplive.net:80/pssimp7ls/geo_d_at_ch/";
        string rtmp_d = "rtmpt://pssimp7lsfs.fplive.net:80/pssimp7ls/geo_d/";
        string rtmp_ww = "rtmpt://pssimp7lsfs.fplive.net:80/pssimp7ls/geo_worldwide/";
