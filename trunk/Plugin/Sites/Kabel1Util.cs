...
{
    public class Kabel1Util : SiteUtilBase
    {
        ...
        string baseUrl = "http://cms029.dc2.qcn3.movenetworks.com/cms/publish/vod2/vodchannelcatalog/kabel1/36/catalog.json";
        string vidListBaseUrl = "http://cms029.dc2.qcn3.movenetworks.com/cms/publish/pro7/vodtldatesorted//";

        string rtmp_d_at_ch = "rtmpt://pssimkabel1fs.fplive.net:80/pssimkabel1ls/geo_d_at_ch/";
        string rtmp_d = "rtmpt://pssimkabel1fs.fplive.net:80/pssimkabel1ls/geo_d/";
        string rtmp_ww = "rtmpt://pssimkabel1fs.fplive.net:80/pssimkabel1ls/geo_worldwide/";
