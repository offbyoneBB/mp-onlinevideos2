...
#define FFMPEG_CONFIGURATION "--extra-cflags='-mmmx -msse' --enable-shared --enable-gpl --enable-w32threads --enable-runtime-cpudetect --enable-asm --enable-zlib --enable-swscale --enable-avfilter --disable-filters --enable-filter=yadif --enable-filter=buffer --enable-filter=buffersink --enable-filter=scale --disable-protocols --enable-protocol=file --disable-muxers --enable-muxer=spdif --disable-swresample --disable-postproc --disable-static --disable-altivec --disable-encoders --disable-debug --disable-ffplay --disable-ffserver --disable-ffmpeg --disable-avconv --disable-ffprobe --disable-devices --disable-avdevice --disable-hwaccels --disable-bsfs --disable-network --arch=x86 --cpu=i686 --target-os=mingw32 --build-suffix=-mpurlsourcesplitter"
