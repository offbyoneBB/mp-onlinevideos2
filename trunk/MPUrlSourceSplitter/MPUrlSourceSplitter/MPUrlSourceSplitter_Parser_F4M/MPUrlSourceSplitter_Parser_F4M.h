...
//#define F4M_FILE_HEADER                                           L"<?xml version="1.0" encoding="UTF-8"?>"

#define F4M_ELEMENT_MANIFEST                                      "<manifest"
#define F4M_ELEMENT_MANIFEST_LENGTH                               9
#define F4M_ELEMENT_MANIFEST_ATTRIBUTE_XMLNS                      "xmlns"
#define F4M_ELEMENT_MANIFEST_ATTRIBUTE_XMLNS_LENGTH               5
#define F4M_ELEMENT_MANIFEST_ATTRIBUTE_XMLNS_VALUE                "http://ns.adobe.com/f4m/1.0"
#define F4M_ELEMENT_MANIFEST_ATTRIBUTE_XMLNS_VALUE_LENGTH         27

// This class is exported from the MPUrlSourceSplitter_Parser_F4M.dll
class MPURLSOURCESPLITTER_PARSER_F4M_API CMPUrlSourceSplitter_Parser_F4M : public IParserPlugin
{
public:
  // constructor
