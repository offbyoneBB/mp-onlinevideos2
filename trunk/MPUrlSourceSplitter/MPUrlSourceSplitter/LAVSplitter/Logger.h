...
#define METHOD_OPEN_CONNECTION_NAME                                     L"OpenConnection()"
#define METHOD_CLOSE_CONNECTION_NAME                                    L"CloseConnection()"
#define METHOD_RECEIVE_DATA_NAME                                        L"ReceiveData()"
#define METHOD_PUSH_MEDIA_PACKET_NAME                                   L"PushMediaPacket()"
#define METHOD_RECEIVE_DATA_FROM_TIMESTAMP_NAME                         L"ReceiveDataFromTimestamp()"
#define METHOD_ABORT_STREAM_RECEIVE_NAME                                L"AbortStreamReceive()"
