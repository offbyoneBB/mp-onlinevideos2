...
#ifndef __SEGMENT_RUN_TABLE_BOX_COLLECTION_DEFINED
#define __SEGMENT_RUN_TABLE_BOX_COLLECTION_DEFINED

#include "Collection.h"
#include "SegmentRunTableBox.h"

class CSegmentRunTableBoxCollection : public CCollection<CSegmentRunTableBox, const wchar_t *>
{
public:
...
protected:
  ...
  const wchar_t *GetKey(CSegmentRunTableBox *item);

  // clones specified item
  // @param item : the item to clone
  // @return : deep clone of item or NULL if not implemented
  CSegmentRunTableBox *Clone(CSegmentRunTableBox *item);
};
