...
#ifndef __BOOTSTRAP_INFO_QUALITY_ENTRY_COLLECTION_DEFINED
#define __BOOTSTRAP_INFO_QUALITY_ENTRY_COLLECTION_DEFINED

#include "Collection.h"
#include "BootstrapInfoQualityEntry.h"

class CBootstrapInfoQualityEntryCollection : public CCollection<CBootstrapInfoQualityEntry, const wchar_t *>
{
public:
...
protected:
  ...
  const wchar_t *GetKey(CBootstrapInfoQualityEntry *item);

  // clones specified item
  // @param item : the item to clone
  // @return : deep clone of item or NULL if not implemented
  CBootstrapInfoQualityEntry *Clone(CBootstrapInfoQualityEntry *item);
};
