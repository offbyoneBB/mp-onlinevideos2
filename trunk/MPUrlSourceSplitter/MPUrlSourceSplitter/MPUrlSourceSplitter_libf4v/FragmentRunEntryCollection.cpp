...
int CFragmentRunEntryCollection::CompareItemKeys(const wchar_t *firstKey, const wchar_t *secondKey, void *context)
{
...
const wchar_t *CFragmentRunEntryCollection::GetKey(CFragmentRunEntry *item)
{
  return L"";
}
