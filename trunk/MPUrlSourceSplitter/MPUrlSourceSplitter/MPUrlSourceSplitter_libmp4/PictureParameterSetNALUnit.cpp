...
uint16_t CPictureParameterSetNALUnit::GetLength(void)
{
  return this->length;
}

const uint8_t *CPictureParameterSetNALUnit::GetBuffer(void)
{
  return this->buffer;
}
...
bool CPictureParameterSetNALUnit::SetBuffer(const uint8_t *buffer, uint16_t length)
{
