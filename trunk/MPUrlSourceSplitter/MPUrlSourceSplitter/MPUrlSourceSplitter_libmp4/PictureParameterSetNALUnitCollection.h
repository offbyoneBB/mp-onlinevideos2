...
#ifndef __PICTURE_PARAMETER_SET_NAL_UNIT_COLLECTION_DEFINED
#define __PICTURE_PARAMETER_SET_NAL_UNIT_COLLECTION_DEFINED

#include "Collection.h"
#include "PictureParameterSetNALUnit.h"

class CPictureParameterSetNALUnitCollection : public CCollection<CPictureParameterSetNALUnit, const wchar_t *>
{
public:
...
protected:
  ...
  const wchar_t *GetKey(CPictureParameterSetNALUnit *item);

  // clones specified item
  // @param item : the item to clone
  // @return : deep clone of item or NULL if not implemented
  CPictureParameterSetNALUnit *Clone(CPictureParameterSetNALUnit *item);
