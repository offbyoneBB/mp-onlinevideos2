...
#ifndef __F4M_MEDIA_COLLECTION_DEFINED
#define __F4M_MEDIA_COLLECTION_DEFINED

#include "Collection.h"
#include "F4MMedia.h"

class CF4MMediaCollection : public CCollection<CF4MMedia, const wchar_t *>
{
public:
...
protected:
  ...
  const wchar_t *GetKey(CF4MMedia *item);

  // clones specified item
  // @param item : the item to clone
  // @return : deep clone of item or NULL if not implemented
  CF4MMedia *Clone(CF4MMedia *item);
};
