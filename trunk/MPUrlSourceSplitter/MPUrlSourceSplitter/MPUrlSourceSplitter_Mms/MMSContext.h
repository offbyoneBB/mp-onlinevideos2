...
class MPURLSOURCESPLITTER_MMS_API MMSContext
{
public:
  // constructor
...
//    bool header_parsed;                   // the header has been received and parsed
//    int asf_packet_len;
...
//
//    int request_sequence;                 // request packet sequence
//    int chunk_sequence;                   // data packet sequence
//} MMSContext;
