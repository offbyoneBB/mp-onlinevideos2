...
#ifndef __TIME_TO_SAMPLE_COLLECTION_DEFINED
#define __TIME_TO_SAMPLE_COLLECTION_DEFINED

#include "Collection.h"
#include "TimeToSample.h"

class CTimeToSampleCollection : public CCollection<CTimeToSample, const wchar_t *>
{
public:
...
protected:
  ...
  const wchar_t *GetKey(CTimeToSample *item);

  // clones specified item
  // @param item : the item to clone
  // @return : deep clone of item or NULL if not implemented
  CTimeToSample *Clone(CTimeToSample *item);
