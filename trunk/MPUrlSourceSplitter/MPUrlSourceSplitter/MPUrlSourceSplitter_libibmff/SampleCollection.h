...
#ifndef __SAMPLE_COLLECTION_DEFINED
#define __SAMPLE_COLLECTION_DEFINED

#include "Collection.h"
#include "Sample.h"

class CSampleCollection : public CCollection<CSample, const wchar_t *>
{
public:
...
protected:
  ...
  const wchar_t *GetKey(CSample *item);

  // clones specified item
  // @param item : the item to clone
  // @return : deep clone of item or NULL if not implemented
  CSample *Clone(CSample *item);
