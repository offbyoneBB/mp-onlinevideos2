...
#ifndef __DATA_ENTRY_BOX_COLLECTION_DEFINED
#define __DATA_ENTRY_BOX_COLLECTION_DEFINED

#include "Collection.h"
#include "DataEntryBox.h"

class CDataEntryBoxCollection : public CCollection<CDataEntryBox, const wchar_t *>
{
public:
...
protected:
  ...
  const wchar_t *GetKey(CDataEntryBox *item);

  // clones specified item
  // @param item : the item to clone
  // @return : deep clone of item or NULL if not implemented
  CDataEntryBox *Clone(CDataEntryBox *item);
};
