...
#ifndef __CHUNK_LARGE_OFFSET_BOX_DEFINED
#define __CHUNK_LARGE_OFFSET_BOX_DEFINED

#include "FullBox.h"
#include "ChunkOffsetCollection.h"

#define CHUNK_LARGE_OFFSET_BOX_TYPE                                           L"co64"

class CChunkLargeOffsetBox :
  public CFullBox
{
public:
  // initializes a new instance of CChunkLargeOffsetBox class
  CChunkLargeOffsetBox(void);

  // destructor
  virtual ~CChunkLargeOffsetBox(void);
