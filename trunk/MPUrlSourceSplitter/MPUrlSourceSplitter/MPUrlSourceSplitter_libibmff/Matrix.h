...
class CMatrix : public CCollection<CFixedPointNumber, const wchar_t *>
{
public:
  CMatrix(void);
  ~CMatrix(void);
  ...
  // @return : always false
  virtual bool Append(CCollection<CFixedPointNumber, const wchar_t *> *collection);
...
protected:
  ...
  const wchar_t *GetKey(CFixedPointNumber *item);
