...
#ifndef __SAMPLE_ENTRY_BOX_COLLECTION_DEFINED
#define __SAMPLE_ENTRY_BOX_COLLECTION_DEFINED

#include "Collection.h"
#include "SampleEntryBox.h"

class CSampleEntryBoxCollection : public CCollection<CSampleEntryBox, const wchar_t *>
{
public:
...
protected:
  ...
  const wchar_t *GetKey(CSampleEntryBox *item);

  // clones specified item
  // @param item : the item to clone
  // @return : deep clone of item or NULL if not implemented
  CSampleEntryBox *Clone(CSampleEntryBox *item);
};
